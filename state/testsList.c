...
bool testGetValue() {
    ...
    Value value = { NULL, 1 };
    addInHead(list, value, &errorCode);
    bool result = (getValue(list, firstElement(list)).length == 1);
    deleteList(list);
    return result && errorCode == 0;
}
...
bool testAddInTail() {
    ...
    bool result = (getValue(list, lastElement(list)).length == 3);
    deleteElement(list, lastElement(list));
    result = (getValue(list, lastElement(list)).length == 2);
    deleteElement(list, lastElement(list));
    result = (getValue(list, lastElement(list)).length == 1);
    deleteElement(list, lastElement(list));
    deleteList(list);
    return result && errorCode == 0;
}
...
bool testAddValue() {
    ...
    bool result = (getValue(list, firstElement(list)).length == 2);
    deleteElement(list, position);
    result = (getValue(list, firstElement(list)).length == 1);
    deleteList(list);
    return result && errorCode == 0;
}
...
bool testDeleteElement() {
    ...
    deleteElement(list, position);
    bool result = (getValue(list, position).length == 2);
    deleteList(list);
    return result && errorCode == 0;
}
...
bool testGetElement() {
    ...
    addInHead(list, value2, &errorCode);
    addInHead(list, value3, &errorCode);
    bool result = (getValue(list, getElement(list, 1)).length == 2);
    deleteList(list);
    return result && errorCode == 0;
}
